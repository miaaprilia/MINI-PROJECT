...
public class ProductSteps {
    ...
    public void select1OrMoreProductsOnTheHomePage() {
        productPage.select1OrMoreProductsOnTheHomePage();
    }
    ...
    public void enterValidCredentials() {
        loginPage.inputForm("miaaprilia2803@gmail.com", "test");
    }
    ...
    public void addedAndThenRemoveProductFromTheCart() {
        productPage.addedAndThenRemoveProductFromTheCart();
    }

    @Then ( "I see message appear \"Order is empty!\" in order page" )
    public void seeMessageAppearOrderIsEmptyInOrderPage() {
        Assertions.assertTrue(productPage.validateOnProductPage());
    }
}
